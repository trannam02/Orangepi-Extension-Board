...
/* Private defines -----------------------------------------------------------*/
#define LED_DEBUG_KIT_Pin GPIO_PIN_13
#define LED_DEBUG_KIT_GPIO_Port GPIOC
#define KNX_RESETb_Pin GPIO_PIN_13
#define KNX_RESETb_GPIO_Port GPIOB
#define KNX_SAVEb_Pin GPIO_PIN_14
